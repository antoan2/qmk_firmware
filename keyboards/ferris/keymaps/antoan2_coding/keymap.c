...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT(
        KC_TRNS, KC_TRNS, KC_MUTE, KC_MEDIA_PLAY_PAUSE, KC_TRNS,               KC_TRNS, KC_MS_WH_DOWN,  KC_MS_WH_UP, KC_TRNS,  KC_TRNS,
        KC_MEDIA_PREV_TRACK, KC_VOLU, KC_VOLD, KC_MEDIA_NEXT_TRACK, KC_TRNS,               KC_LEFT, KC_DOWN,      KC_UP,         KC_RIGHT, KC_TRNS,
        KC_MEDIA_REWIND, KC_TRNS, KC_TRNS,             KC_TRNS,             KC_TRNS,               KC_HOME, KC_PAGE_DOWN, KC_PAGE_UP,    KC_END,  KC_TRNS,
                                                           KC_TRNS,             KC_TRNS,               KC_TRNS, KC_TRNS
    ),
	[_SYM] = LAYOUT(
