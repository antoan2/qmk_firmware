...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT(
        KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK,  KC_VOLU,     KC_VOLD,                KC_TRNS,      KC_TRNS, KC_MS_WH_DOWN, KC_MS_WH_UP,  KC_TRNS,    KC_TRNS,
        KC_LEFT_GUI,         KC_LEFT_ALT,       KC_LEFT_CTRL,        KC_LEFT_SHIFT,          KC_TRNS,      KC_TRNS, KC_DOWN,       KC_UP,      KC_LEFT,      KC_RIGHT,
        KC_MEDIA_REWIND, KC_MEDIA_FAST_FORWARD,     KC_MUTE,     KC_MEDIA_PLAY_PAUSE,  KC_TRNS,      KC_TRNS, KC_HOME,       KC_PAGE_DOWN, KC_PAGE_UP, KC_END,
                                                           KC_TRNS,             KC_TRNS,               KC_TRNS, KC_TRNS
    ),
	[_SYM] = LAYOUT(
    ...
    [_MOUSE] = LAYOUT(
        KC_TRNS, KC_MS_BTN1, KC_TRNS, KC_MS_BTN2, KC_TRNS,             QK_DYNAMIC_TAPPING_TERM_UP,  KC_MS_WH_UP, KC_TRNS,       KC_TRNS, KC_TRNS,
        KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS,    KC_TRNS,             QK_DYNAMIC_TAPPING_TERM_DOWN,  KC_MS_UP,    KC_MS_DOWN,    KC_MS_LEFT,    KC_MS_RIGHT,
        KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS,    KC_TRNS,             QK_DYNAMIC_TAPPING_TERM_PRINT,  KC_MS_WH_UP, KC_MS_WH_DOWN, KC_TRNS,     KC_TRNS,
                                                  KC_TRNS,    KC_TRNS,             KC_TRNS,  KC_TRNS
    ),
};
