...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_NAV] = LAYOUT(
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS, KC_TRNS,KC_TRNS,KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,               KC_LEFT, KC_DOWN,             KC_UP,                   KC_RIGHT,        KC_DOUBLE_QUOTE,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS,     KC_TRNS,       KC_TRNS,        KC_TRNS,
                                               KC_TRNS, KC_TRNS,               KC_TRNS, KC_TRNS
    ),
	[_SYM] = LAYOUT(
        KC_TILDE,    KC_AT,        KC_HASH,     KC_DOLLAR,     KC_PERCENT,      KC_CIRCUMFLEX, KC_AMPERSAND, KC_ASTERISK, KC_QUESTION, KC_DOUBLE_QUOTE,
        KC_EXCLAIM,KC_LEFT_PAREN, KC_LEFT_BRACKET, KC_UNDERSCORE, KC_MINUS, KC_PLUS, KC_EQUAL, KC_RIGHT_BRACKET, KC_RIGHT_PAREN, KC_QUOTE ,
        KC_GRAVE,      KC_TRNS,     KC_LEFT_CURLY_BRACE,     KC_LEFT_ANGLE_BRACKET,      KC_TRNS,         KC_TRNS, KC_RIGHT_ANGLE_BRACKET, KC_RIGHT_CURLY_BRACE, KC_PIPE, KC_BACKSLASH,
                                                              KC_TRNS,       KC_TRNS,          KC_TRNS, KC_TRNS
    ),
[_NUM] = LAYOUT(
